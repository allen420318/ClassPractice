var MenuLayer = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        var menu = new cc.Menu(item1,item2,item3,item4,item5,item6,item7,item8,item9);
    ...
    item4: function () {
        ...
        storage.setItem("usename","brad");
    },

    item5: function () {
        var storage = cc.sys.localStorage;
        var stage = storage.getItem("stage");
        var user = storage.getItem("usename");
        cc.log(user + ":" + stage);
    },

    item6: function () {
        var storage = cc.sys.localStorage;
        storage.removeItem("stage","4");
        storage.removeItem("usename","brad");
    },
